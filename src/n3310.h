...
#define LCD_DC_PIN				GPIO_Pin_6//14
#define LCD_CE_PIN				GPIO_Pin_5//13
#define LCD_RST_PIN				GPIO_Pin_4//12
#define LCD_SDIN_PIN			GPIO_Pin_7//15
#define LCD_SCLK_PIN			GPIO_Pin_8//3
#define LCD_LED_PIN			    GPIO_Pin_3//3

#define SET_LED					GPIO_SetBits(LCD_PORT, LCD_LED_PIN)
#define RESET_LED				GPIO_ResetBits(LCD_PORT, LCD_LED_PIN)
